def migrate(cr, version):
    # pass
    old_table = 'skill_development_help_popup'
    new_table = 'skill_development_progress_guide'
    old_model = 'skill_development.help_popup'
    new_model = 'skill_development.progress_guide'
