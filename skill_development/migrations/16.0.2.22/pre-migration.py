def migrate(cr, version):
    # pass
    old_table = 'skill_development_career_path'
    new_table = 'skill_development_skill_career'
    old_model = 'skill_development.career_path'
    new_model = 'skill_development.skill.career'
