def migrate(cr, version):
    # pass
    old_table = 'skill_development_goal_result'
    new_table = 'skill_development_goal_result'
    old_model = 'skill_development.goal.result'
    new_model = 'skill_development.goal_result'
